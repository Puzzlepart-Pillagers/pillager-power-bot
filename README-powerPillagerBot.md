# Power Pillager - `powerPillagerBot`
...
3. Give the bot a handle (ex: `powerPillagerBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://pillagers-teams-bot.herokuapp.com/api/messages`
